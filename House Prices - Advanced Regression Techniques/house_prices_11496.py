...
averaged_models = em.AveragingModels(models = [model_svr, model_ENet, model_KRR, model_xgb])
...
stacked_averaged_models = em.StackingAveragedModels(base_models = [model_svr, model_ENet, model_KRR, model_xgb],
