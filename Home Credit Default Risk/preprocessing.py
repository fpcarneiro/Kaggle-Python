...
def check_missing(dataset):
    ...
    missing_table = mis_val_table.drop(mis_val_table[mis_val_table.iloc[:, 1] == 0].index).sort_values(
...
def check_flag_doc_cols(dataset):
    ...
    missing_table = mis_val_table.drop(mis_val_table[mis_val_table.iloc[:, 1] == 0].index).sort_values('% of Total',
...
def get_domain_knowledge_features(X):
    ...
    cols_flag_del = ['FLAG_DOCUMENT_16', 'FLAG_DOCUMENT_18', 'FLAG_DOCUMENT_11', 'FLAG_DOCUMENT_9', 'FLAG_DOCUMENT_13',
                     'FLAG_DOCUMENT_14', 'FLAG_DOCUMENT_15', 'FLAG_DOCUMENT_19', 'FLAG_DOCUMENT_20', 'FLAG_DOCUMENT_21',
                     'FLAG_DOCUMENT_17',
...
def agg_categorical_numeric(df, df_name, group_var=['SK_ID_CURR', 'CREDIT_ACTIVE'], funcs=['sum', 'mean'],
                            target_numvar=['DAYS_CREDIT', 'AMT_ANNUITY']):
